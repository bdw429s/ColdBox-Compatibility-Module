...
01/18/2007 - Created
----------------------------------------------------------------------->
<cfcomponent name="PluginService" output="false" hint="The coldbox plugin service" extends="coldbox.system.web.services.BaseService" singleton>

<!------------------------------------------- CONSTRUCTOR ------------------------------------------->

	<cffunction name="init" access="public" output="false" returntype="PluginService" hint="Constructor">
		<cfargument name="controller" type="any" required="true" inject="coldbox">
		<cfscript>
			// setup controller
			setController(arguments.controller);
			
			// Core Plugins Location
			instance.CORE_PLUGINS_PATH = "cbcompat.plugins";
...
<!------------------------------------------- Configure ------------------------------------------->
	...
	<cffunction name="getColdboxOCM" access="public" output="false" returntype="any" hint="Get ColdboxOCM: coldbox.system.cache.CacheManager or new CacheBox providers">
		...
		<cfreturn controller.getCacheBox().getCache( arguments.cacheName )/>
	</cffunction>
	
	<!--- This is the method that used to be in the controller.  The supertype additions funnel through here --->
	<cffunction name="getPlugin" access="Public" returntype="any" hint="I am the Plugin cfc object factory." output="false">
		...
		<cfscript>
			if ( arguments.newInstance ){
				return new(arguments.plugin,arguments.customPlugin,arguments.module,arguments.init);
			}
			return get(arguments.plugin,arguments.customPlugin,arguments.module,arguments.init);
		</cfscript>
	</cffunction>
	
	<cffunction name="postModuleLoad">
		<cfset arguments.interceptData.moduleConfig.pluginInvocationPath = arguments.interceptData.moduleConfig.invocationPath & '.plugins'>
		<cfset arguments.interceptData.moduleConfig.pluginsPhysicalPath = arguments.interceptData.moduleLocation & '/plugins'>
	</cffunction>
<!------------------------------------------- EVENTS ------------------------------------------>
